...
def decoder_block(input, skip_features, num_filters):
    ...
    uconv_attention = attention_layer(uconv)
    con = concatenate([uconv, skip_features])
    con = concatenate([con, uconv_attention])
...
#training
checkpoint_filepath = 'besttfunet_model.h5'
...
fig.savefig('selfunet-loss_and_accuracy_plot.png')
plt.show()
...
fig.savefig('selfunet-validation.png')
plt.show()
